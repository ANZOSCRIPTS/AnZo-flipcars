...
RegisterNetEvent('AnZo-flipcar:CustomNotify')
AddEventHandler('AnZo-flipcar:CustomNotify', function(message, type)
...
Config.RequiredItem = 'flip_jack'		-- Replace 'itemnamehere' with item to be used for flipping vehicles, it is NOT removed on use, it only needs to be in the inventory (can be ignored if Config.AndOr = or and no item is wanted). 
